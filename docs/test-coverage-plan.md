...
test("投稿カードからユーザープロフィールへ遷移できる", async ({ page }) => {
  ...
  // プロフィール情報が表示される（@handleが表示されるのを待つ）
...
## ファイル作成
- [x] `tests/profile-edit.spec.ts` を作成
- [x] `tests/navigation.spec.ts` を作成
- [x] `tests/fixtures/` ディレクトリを作成
- [x] `tests/fixtures/test-avatar.png` を配置
- [x] `tests/fixtures/test-post-image.png` を配置
...
- [x] タスク3: 自己紹介変更
- [x] タスク4: キャンセルボタン
- [x] タスク5: 重複ハンドルバリデーション
- [x] タスク6: 画像付き投稿
- [x] タスク7: 投稿カードからプロフィール遷移
- [x] タスク8: いいねを外す
- [x] タスク9: フォロー統計表示
- [x] タスク10: ナビゲーション各ボタン
- [x] タスク11: 未ログイン時リダイレクト
- [x] タスク12: 無効なURLリダイレクト
- [x] タスク13: 存在しないユーザーのプロフィール
- [x] タスク14: 投稿がないユーザーのプロフィール
- [x] タスク15: 検索結果0件
